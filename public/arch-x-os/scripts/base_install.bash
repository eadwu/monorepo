...
# USAGE:
#   curl https://gitlab.com/arch-dual-boot/arch-x-os/blob/master/scripts/base_install.bash | bash -s -- boot_partition crypt_password country geographic_zone hostname root_password user password locale dual_boot 
