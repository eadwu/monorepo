...
",
        ...
        lhs_interface = tensor_interface("0", "read", "lhs", "vec4<f32>", "lhs_metadata"),
        rhs_interface = tensor_interface("1", "read", "rhs", "vec4<f32>", "rhs_metadata"),
        output_interface =
            tensor_interface("2", "read_write", "output", "vec4<f32>", "output_metadata"),
